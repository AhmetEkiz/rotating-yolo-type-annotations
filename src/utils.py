...
def rotate_annotations(label_PATH, 
                       ouput_folder_PATH,
                       image_name, 
                       image,
                       cx=0.5, cy=0.5, angle=np.radians(90)):
      
	""" Rotate annotations and images then save a file.
	...
	test_image = draw_annotations(rotated_annotation_file_PATH, rotated_image, thickness=2)
