...
def rotate_and_save_dataset(dataset_PATH, output_folder_PATH=" "):
    ...
    for folder in glob.glob(dataset_PATH+"/*/"):
        ...
        for image_PATH in tqdm(glob.glob(sub_folder_PATH+"/images/*")):
            ...
            # # Before Rotating
            # image = utils.draw_bbox_annotations(label_PATH, image)   # draw annotations
            ...
            rotated_annotation_file_PATH, rotated_image_PATH = utils.rotate_bbox_annotations(label_PATH,
